...
export default function NavigationBar() {
  return (
    <Fade top>
      <nav className="navbar navbar-nav navbar-expand-md navbar-light text-uppercase mx-auto py-3">
        <div className="container-fluid">
          <NavLink className="navbar-brand pl-5" to="/">&lt;<img src={logo} alt="logo"/>/&gt;</NavLink>
          <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
          </button>
          <div className="collapse navbar-collapse text-center pl-5" id="navbarNav">
