...
export default class About extends Component {
  ...
  render() {
    return (
      <section id="about">
        <div className="row my-auto m-3 p-2 pt-5 m-3">
          ...
          <div className="col-xl-5 my-auto">
            <div className="about-text outline mb-5 pt-5 ">
              <Fade>
                ...
                <p className="text-center h4 mt-3"> I am a self-taught web developer based in the Bay Area, CA with a passion for building and optimizing interactive, user-friendly, feature-rich websites and web applications. ☺︎ </p>
              </Fade>
            </div>
            <Fade bottom>
